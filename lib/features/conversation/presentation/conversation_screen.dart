...
class ConversationScreen extends StatelessWidget {
                    ...
                    child: Column(
                      children: <Widget>[
                        VoiceHero(
                          ...
                          onStop: () =>
                              unawaited(controller.stopRecording(manual: true)),
                        ),
  ...
  void _showSettings(BuildContext context) {
    showModalBottomSheet<void>(
      ...
      useSafeArea: true,
      showDragHandle: true,
      builder: (_) => SettingsSheet(controller: controller, config: config),
    );
  }
...
class _AppHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final compactInputLabel = switch (inputLabel) {
      final label when label.contains('Android') => 'ASR trực tiếp',
